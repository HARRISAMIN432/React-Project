          ...
          <Row className="flex-col w-[47%] ">
            ...
            <Row className="gap-[20px] mt-[30px]">
              ...
              <p className="text-[18px] text-black">
                ...
                Quisquam quibusdam tenetur aperiam incidunt accusamus, nam sint
                suscipit ipsa sapiente ratione consequuntur aliquid assumenda
                illum magni, numquam possimus quod minus expedita!
              </p>
            </Row>
          </Row>
        </Row>
